...
```
You will need to update `PYRAT_URL` / `PYRAT_CLIENT_TOKEN`/ `PYRAT_USER_TOKEN` to match your PyRAT instance. See [oscar-colony pyrat docs]() for how to create the required tokens.
